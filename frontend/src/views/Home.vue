...
.asset-shell.has-inspector .gallery-stage :deep(.gallery-grid[data-density='compact']) { grid-template-columns: repeat(auto-fill,minmax(min(100%,206px),238px)); justify-content: start; }
