<template>
  <section class="profile-header">
    ...
    <div class="profile-main">
      <Transition name="profile-mode" mode="out-in">
        <div v-if="!editing" key="view" class="profile-view">
...
.profile-mode-enter-active,.profile-mode-leave-active{transition:opacity var(--duration-standard) var(--ease-out),transform var(--duration-standard) var(--ease-out)}
.profile-mode-enter-from,.profile-mode-leave-to{opacity:0;transform:translateY(8px)}
...
@media(prefers-reduced-motion:reduce){.profile-mode-enter-active,.profile-mode-leave-active{transition:opacity 200ms ease}.profile-mode-enter-from,.profile-mode-leave-to{opacity:0;transform:none}}
</style>
