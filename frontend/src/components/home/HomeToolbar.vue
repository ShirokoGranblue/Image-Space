...
h1{max-width:720px;margin:0;font-family:var(--font-title);font-size:clamp(34px,4vw,54px);font-weight:600;line-height:1.08}p{margin:var(--space-3) 0 0;color:var(--color-text-secondary);line-height:var(--leading-md)}
